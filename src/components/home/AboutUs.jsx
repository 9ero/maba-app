...
export const AboutUs = () => {
    ...
    return (<section>
    <h2 style={inView?{opacity: 0}:{opacity:1}} className={style.helperTitle}><span><BsFillArrowDownCircleFill/></span>  More about us  <span><BsFillArrowDownCircleFill/></span></h2>
